                ...
                <tbody>
                    ...
                    <tr data-entry-id="<?php echo e($role->id); ?>">
                        ...
                        <td class="align-middle">
                            ...
                            <a  title="info"  class="btn btn-xs btn-primary" href="<?php echo e(route('admin.roles.show', $role->id)); ?>">
                                <i class="fas fa-info"></i>
                            </a>
                            <?php endif; ?>

                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('role_edit')): ?>
                            <a  title="Edit"  class="btn btn-xs btn-info" href="<?php echo e(route('admin.roles.edit', $role->id)); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel_Project_Azure\pel_am\pel_am\resources\views/admin/roles/index.blade.php ENDPATH**/ ?>