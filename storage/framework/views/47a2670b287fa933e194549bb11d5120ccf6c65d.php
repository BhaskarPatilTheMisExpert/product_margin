...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form autocomplete="off" id="createForm" method="POST" action="<?php echo e(route('admin.frm.store')); ?>" enctype="multipart/form-data" onsubmit="return validateForm()">
            ...
            <div class="row">
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control " name="CaseLogInDate" id="CaseLogInDate" placeholder="" value="" type="date">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('CaseRefToFrm') ? 'is-invalid' : ''); ?>" name="CaseRefToFrm" id="CaseRefToFrm" placeholder="" value="" type="date">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('CaseRefBy') ? 'is-invalid' : ''); ?>" name="CaseRefBy" id="CaseRefBy" placeholder="Case Ref By" value="">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('IfYesReason') ? 'is-invalid' : ''); ?>" name="IfYesReason" id="IfYesReason" placeholder="" value="" type="date">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('FCUInvestigationRpt') ? 'is-invalid' : ''); ?>" name="FCUInvestigationRpt" id="FCUInvestigationRpt" placeholder="FCUInvestigationRpt" value="" type="date">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('FCUPersonnelName') ? 'is-invalid' : ''); ?>" name="FCUPersonnelName" id="FCUPersonnelName" placeholder="FCU Personnel Name" value="">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('LoanID') ? 'is-invalid' : ''); ?>" name="LoanID" id="LoanID" placeholder="Loan ID" value="">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('DisbursedLoanAmount') ? 'is-invalid' : ''); ?>" name="DisbursedLoanAmount" id="DisbursedLoanAmount" placeholder="Disbursed Loan Amount" value="">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('DisbursementDate') ? 'is-invalid' : ''); ?>" name="DisbursementDate" id="DisbursementDate" placeholder="Disbursement Date" value="" type="date">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('Product') ? 'is-invalid' : ''); ?>" name="Product" id="Product" placeholder="Product" value="">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('BorrowalName') ? 'is-invalid' : ''); ?>" name="BorrowalName" id="BorrowalName" placeholder="Borrowal Name" value="">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('PennantBranch') ? 'is-invalid' : ''); ?>" name="PennantBranch" id="PennantBranch" placeholder="Pennant Branch" value="">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('BriefModusOperandi') ? 'is-invalid' : ''); ?>" name="BriefModusOperandi" id="BriefModusOperandi" placeholder="Brief Modus Operandi" value="">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('BriefModusOperandi') ? 'is-invalid' : ''); ?>" name="OneLineModusOperandi" id="OneLineModusOperandi" placeholder="One Line Modus Operandi" value="">
                    <?php if($errors->has('BriefModusOperandi')): ?>
                    <div class="invalid-feedback">
                        <?php echo e($errors->first('BriefModusOperandi')); ?>
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('CaseClosedAboveByChecker') ? 'is-invalid' : ''); ?>" name="CaseClosedAboveByChecker" id="CaseClosedAboveByChecker" placeholder="Case Closed Above By Checker" value="">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('PresentingToFRMC') ? 'is-invalid' : ''); ?>" name="PresentingToFRMC" id="PresentingToFRMC" placeholder="Case Closed Above By Checker" value="">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('fillFRMCDate') ? 'is-invalid' : ''); ?>" name="fillFRMCDate" id="fillFRMCDate" placeholder="Case Closed Above By Checker" value="" type="date">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('FRMCActionable') ? 'is-invalid' : ''); ?>" name="FRMCActionable" id="FRMCActionable" placeholder="FRMC Actionable" value="" >
                    <?php if($errors->has('fillFRMCDate')): ?>
                    <div class="invalid-feedback">
                        <?php echo e($errors->first('fillFRMCDate')); ?>
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('FRMCActionableStaDescri') ? 'is-invalid' : ''); ?>" name="FRMCActionableStaDescri" id="FRMCActionableStaDescri" placeholder="FRMC actionable status description" value="" >
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('FRMCActionableDetails') ? 'is-invalid' : ''); ?>" name="FRMCActionableDetails" id="FRMCActionableDetails" placeholder="FRMC actionable status description" value="" >
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('DateForPrincipalOutstanding') ? 'is-invalid' : ''); ?>" name="DateForPrincipalOutstanding" id="DateForPrincipalOutstanding" placeholder="Select date for Principal Outstanding" value="" type="date">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('DateOfClosure') ? 'is-invalid' : ''); ?>" name="DateOfClosure" id="DateOfClosure" placeholder="Estimated date of closure (not part of FMR 1)" value="" >
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('DateOfPoliceComplaint') ? 'is-invalid' : ''); ?>" name="DateOfPoliceComplaint" id="DateOfPoliceComplaint" placeholder="Date of police complaint can be filled anytime" value="" type="date">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel_Project_Azure\pel_am\pel_am\resources\views/admin/frm/create.blade.php ENDPATH**/ ?>