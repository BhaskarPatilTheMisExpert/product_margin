...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form autocomplete="off" id="createForm" method="POST" action="<?php echo e(route('admin.fmr.store')); ?>" enctype="multipart/form-data" onsubmit="return validateForm()">
            ...
            <div class="row">
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('fraudEntity') ? 'is-invalid' : ''); ?>" name="fraudEntity" id="fraudEntity" placeholder="" value="<?php echo e($entity->short_code); ?>" readonly>
                    <input class="form-control  <?php echo e($errors->has('fraudEntity') ? 'is-invalid' : ''); ?>" name="entity" id="fraudEntity" placeholder="" value="<?php echo e($entity->id); ?>" hidden>
                    <?php endif; ?>
                ...
                <div class="form-group col-sm-3">
                    ...
                    <!-- <input class="form-control  <?php echo e($errors->has('FraudNumber') ? 'is-invalid' : ''); ?>" name="FraudNumber" id="FraudNumber" placeholder="" value="<?php echo e($generatedCode ?? $fmrDetails->fraud_number ?? ''); ?>"> -->
                    <?php if($flag == true): ?>
                    ...
                    <?php else: ?>
                    <input class="form-control  <?php echo e($errors->has('FraudNumber') ? 'is-invalid' : ''); ?>" name="FraudNumber" id="FraudNumber" placeholder="" value="<?php echo e(@$fmrDetails->fraud_number); ?>">
                    <?php endif; ?>
                ...
                <div class="form-group col-sm-3 .d-inline-flex align-items-center">
                    <label class="required" for="FraudNumber">Loan Account Number</label>
                    <div class="row no-gutters">
                        <div class="col-sm-10 text-right">
                            <input class="form-control <?php echo e($errors->has('FraudNumber') ? 'is-invalid' : ''); ?>" name="lan" id="lan" placeholder="" value="">
                        </div>
                        <div class="col-sm-2 text-left">
                            <button type="button" class="btn btn-default btn-md" onclick="getLanDetails()" id="refBtn"> <i class="fa fa-refresh" aria-hidden="true"></i> </button>
                        </div>


                    </div>
                    <input class="form-control" name="lanFlag" id="lanFlag" placeholder="" value="<?php echo e(@$flag); ?>" hidden> <?php if($errors->has('lan')): ?>
                    <div class="invalid-feedback">
            ...
            <div class="row">
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('nameOfBranch') ? 'is-invalid' : ''); ?>" name="nameOfBranch" id="nameOfBranch" placeholder="Name of branch" value="<?php echo e(old('nameOfBranch') ??  @$fmrDetails->branch_name ?? ''); ?>">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('BranchType') ? 'is-invalid' : ''); ?>" name="BranchType" id="BranchType" placeholder="Branch Type" value="<?php echo e(old('BranchType') ?? @$fmrDetails->branch_type ?? ''); ?>">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('place') ? 'is-invalid' : ''); ?>" name="branchPlace" id="branchPlace" placeholder="Branch Place" value="<?php echo e(old('branchPlace') ?? $fmrDetails->branch_place ?? ''); ?>">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('district') ? 'is-invalid' : ''); ?>" name="district" id="district" placeholder="District" value="<?php echo e(old('district') ?? @$fmrDetails->branch_district ?? ''); ?>">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('state') ? 'is-invalid' : ''); ?>" name="state" id="state" placeholder="State" value="<?php echo e(old('state') ?? @$fmrDetails->branch_state ?? ''); ?>">
            ...
            <div class="row">
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('principalAc') ? 'is-invalid' : ''); ?>" name="principalAc" id="principalAc" placeholder="Name of the principal party/account" value="<?php echo e(old('principalAc') ?? ''); ?>">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('area') ? 'is-invalid' : ''); ?>" name="area" id="area" placeholder="Area of operation where the fraud has occurred?" value="<?php echo e(old('area') ?? ''); ?>">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <select class="form-control <?php echo e($errors->has('fraudBAc') ? 'is-invalid' : ''); ?>" name="fraudBAc" id="fraudBAc">
                        <option value="">Select</option>
                        <option value="Y" <?php echo e(isset($fmrDetails) && $fmrDetails->fraud_borrower_account == 'Y' ? 'selected' : ''); ?>>Yes</option>
                        <option value="N" <?php echo e(isset($fmrDetails) && $fmrDetails->fraud_borrower_account == 'N' ? 'selected' : ''); ?>>No</option>
                    </select>
                ...
                <div class="form-group col-sm-3">
                    ...
                    <select class="form-control <?php echo e($errors->has('natureOfFraud') ? 'is-invalid' : ''); ?>" name="natureOfFraud" id="natureOfFraud">
                        <option value="">Select</option>
                        <option value="Misappropriation and criminal breach of trust" <?php echo e(isset($fmrDetails) && $fmrDetails->fraud_nature == 'Misappropriation and criminal breach of trust' ? 'selected' : ''); ?>>Misappropriation and criminal breach of trust</option>
                        <option value="Fraudulent encashment through forged instruments, manipulation of books of account or through fictitious accounts and conversion of property" <?php echo e(isset($fmrDetails) && $fmrDetails->fraud_nature == 'Fraudulent encashment through forged instruments, manipulation of books of account or through fictitious accounts and conversion of property' ? 'selected' : ''); ?>>Fraudulent encashment through forged instruments, manipulation of books of account or through fictitious accounts and conversion of property</option>
                        <option value="Unauthorised credit facilities extended for reward or for illegal gratification" <?php echo e(isset($fmrDetails) && $fmrDetails->fraud_nature == 'Unauthorised credit facilities extended for reward or for illegal gratification' ? 'selected' : ''); ?>>Unauthorised credit facilities extended for reward or for illegal gratification</option>
                        <option value="Negligence and cash shortages" <?php echo e(isset($fmrDetails) && $fmrDetails->fraud_nature == 'Negligence and cash shortages' ? 'selected' : ''); ?>>Negligence and cash shortages</option>
                        <option value="Cheating and forgery" <?php echo e(isset($fmrDetails) && $fmrDetails->fraud_nature == 'Cheating and forgery' ? 'selected' : ''); ?>>Cheating and forgery</option>
                        <option value="Irregularities in foreign exchange transactions">Irregularities in foreign exchange transactions</option>
                        <option value="Any other type of fraud not coming under the specific heads as above." <?php echo e(isset($fmrDetails) && $fmrDetails->fraud_nature == 'Any other type of fraud not coming under the specific heads as above.' ? 'selected' : ''); ?>>Any other type of fraud not coming under the specific heads as above.</option>
                    </select>
                ...
                <div class="form-group col-sm-3">
                    <label class="required" for="compUse">Computer used in fraud</label>
                    <select class="form-control <?php echo e($errors->has('compUse') ? 'is-invalid' : ''); ?>" name="compUse" id="compUse">
                        <option value="">Select</option>
                        <option value="Y" <?php echo e(@$fmrDetails->is_computer_used == 'Y' ? 'selected' : ''); ?>>Yes</option>
                ...
                <div class="form-group col-sm-3">
                    ...
                    <textarea class="form-control <?php echo e($errors->has('description') ? 'is-invalid' : ''); ?>" name="description" id="description" value="<?php echo e($fmrDetails->computer_description ?? ''); ?>" placeholder="Description"><?php echo e($fmrDetails->computer_description ?? ''); ?></textarea>
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('totalAmt') ? 'is-invalid' : ''); ?>" name="totalAmt" id="totalAmt" placeholder="Total amount involved (₹ in lakh)" value="<?php echo e(old('totalAmt') ?? ''); ?>" type="number">
                ...
                <div class="form-group col-sm-3">
                    <label class="required" for="principalOutstandingDate">Principal Outstanding Date</label> 
                     <!-- principal_outstanding -->
                    <input class="form-control  <?php echo e($errors->has('principalOutstandingDate') ? 'is-invalid' : ''); ?>" name="principalOutstandingDate" id="principalOutstandingDate" placeholder="Principal outstanding date" value="<?php echo e(old('principalOutstandingDate') ?? ''); ?>" type="date">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <!-- principal_outstanding -->
                    <input class="form-control  <?php echo e($errors->has('principalOutstanding') ? 'is-invalid' : ''); ?>" name="principalOutstanding" id="principalOutstanding" placeholder="Principal outstanding (₹ in lakh)" value="<?php echo e(old('principalOutstanding') ?? ''); ?>" type="number" step="0.01">
                ...
                <div class="form-group col-sm-3">
                    <label class="" for="dateOfOccu">Date of Occurrence</label>
                    <input class="form-control  <?php echo e($errors->has('dateOfOccu') ? 'is-invalid' : ''); ?>" name="dateOfOccu" id="dateOfOccu" placeholder="" value="" type="date">
                ...
                <div class="form-group col-sm-3">
                    <label class="" for="dateOfDetect">Date of Detection</label>
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('area') ? 'is-invalid' : ''); ?>" name="reasonDelay" id="reasonDelay" placeholder="If any, in detecting the fraud " value="<?php echo e(old('reasonDelay') ?? $fmrDetails->fraud_delay_reason ?? ''); ?>">
                ...
                <div class="form-group col-sm-3">
                    <label class="" for="dateOfRptRbi">Date on which reported to RBI?</label>
                ...
                <div class="form-group col-sm-3">
                    ...
                    <textarea class="form-control  <?php echo e($errors->has('modusOperandi') ? 'is-invalid' : ''); ?>" name="modusOperandi" id="modusOperandi" placeholder="Enter modus operandi" value="<?php echo e($fmrDetails->modus_operandi ?? ''); ?>" rows="2"><?php echo e($fmrDetails->modus_operandi ?? ''); ?></textarea>
            ...
            <div class="row">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <select class="form-control <?php echo e($errors->has('outsider') ? 'is-invalid' : ''); ?>" name="outsider" id="outsider">
                        ...
                        <option value="N" <?php echo e(@$fmrDetails->fraud_outsider == 'N' ? 'selected' : ''); ?>>No</option>
                    </select>
            ...
            <div class="row">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <textarea class="form-control  <?php echo e($errors->has('intInsAudit') ? 'is-invalid' : ''); ?>" name="intInsAudit" id="intInsAudit" placeholder="Whether internal inspection/audit (including concurrent audit(es) during the period between the date of first occurrence of fraud and its detections?" value="<?php echo e($fmrDetails->internal_detection ?? ''); ?>" rows="2"><?php echo e($fmrDetails->internal_detection ?? ''); ?></textarea>
                ...
                <div class="form-group col-sm-3">
                    ...
                    <textarea class="form-control  <?php echo e($errors->has('yFraud') ? 'is-invalid' : ''); ?>" name="yFraud" id="yFraud" placeholder="If yes, why the fraud could not have   been detected during such inspection/audit." value="<?php echo e($fmrDetails->internal_detection_reason ?? ''); ?>" rows="2"><?php echo e($fmrDetails->internal_detection_reason ?? ''); ?></textarea>
                ...
                <div class="form-group col-sm-3">
                    ...
                    <textarea class="form-control  <?php echo e($errors->has('actionTaken') ? 'is-invalid' : ''); ?>" name="actionTaken" id="actionTaken" placeholder="What action has been taken for non-detection of fraud during such inspection/audit" value="<?php echo e($fmrDetails->non_detection_action ?? ''); ?>" rows="2"><?php echo e($fmrDetails->non_detection_action ?? ''); ?></textarea>
            ...
            <div class="row">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('policeStationName') ? 'is-invalid' : ''); ?>" name="policeStationName" id="policeStationName" placeholder="If yes, name of the Police Station or NA" value="<?php echo e($fmrDetails->police_station ?? ''); ?>" type="">
                ...
                <div class="form-group col-sm-3">
                    <label class="" for="dateOfRef">Date of reference</label>
                ...
                <div class="form-group col-sm-3">
                    <label class="" for="dateOfCPI">Date of completion of Police investigation</label>
                ...
                <div class="form-group col-sm-3">
                    <label class="" for="dateOfSubInvReport">Date of submission of investigation report</label>
                    <input class="form-control  <?php echo e($errors->has('dateOfSubInvReport') ? 'is-invalid' : ''); ?>" name="dateOfSubInvReport" id="dateOfSubInvReport" placeholder="Yet to complete or Date of completion" value="<?php echo e($fmrDetails->investigation_report_date ?? ''); ?>" type="">
            ...
            <div class="row">
                ...
                <div class="form-group col-sm-3">
                    <label class="" for="DofFilling">Date of filling</label>
            ...
            <div class="row">
                ...
                <div class="form-group col-sm-3">
                    <label class="" for="clainLodgeReason">If not, reason therefore</label>
            ...
            <div class="row">
                <div class="form-group col-sm-3" style="display: none;">
                    ...
                    <input class="form-control  <?php echo e($errors->has('deptInquiryNum') ? 'is-invalid' : ''); ?>" name="deptInquiryNum" id="deptInquiry" placeholder="NA or details" value="1" type="hidden">
            ...
            <div class="row">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('amtRecover') ? 'is-invalid' : ''); ?>" name="amtRecover" id="amtRecover" placeholder="Party/ parties amount " value="<?php echo e($fmrDetails->recovery_amount ?? ''); ?>" type="number">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('frmInsurance') ? 'is-invalid' : ''); ?>" name="frmInsurance" id="frmInsurance" placeholder="Recovery from insurance " value="<?php echo e($fmrDetails->insurance_amount ?? ''); ?>" type="number">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('otherSrc') ? 'is-invalid' : ''); ?>" name="otherSrc" id="otherSrc" placeholder="Recovery from other sources " value="<?php echo e($fmrDetails->other_amount ?? ''); ?>" type="number">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('extentLoss') ? 'is-invalid' : ''); ?>" name="extentLoss" id="extentLoss" placeholder="Extent of loss amount " value="<?php echo e($fmrDetails->loss_to_hfc ?? ''); ?>" type="number">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('provisionheld') ? 'is-invalid' : ''); ?>" name="provisionheld" id="provisionheld" placeholder="Provision held amount " value="<?php echo e($fmrDetails->provision_amount ?? ''); ?>" type="number">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('amtWrittenOff') ? 'is-invalid' : ''); ?>" name="amtWrittenOff" id="amtWrittenOff" placeholder="Written of amount " value="<?php echo e($fmrDetails->return_of_amount ?? ''); ?>" type="number">
            ...
            <div class="row">
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('typeOfParty') ? 'is-invalid' : ''); ?>" name="typeOfParty" id="typeOfParty" placeholder="Type Of Party " value="<?php echo e($fmrDetails->borrowerDetails->type_of_party ?? ''); ?>" type="">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('nameOfParty') ? 'is-invalid' : ''); ?>" name="nameOfParty" id="nameOfParty" placeholder="Name Of Party" value="" type="">
                ...
                <div class="form-group col-sm-6">
                    ...
                    <input class="form-control  <?php echo e($errors->has('partyAddress') ? 'is-invalid' : ''); ?>" name="partyAddress" id="partyAddress" placeholder="Party Address " value="" type="">
            ...
            <div class="row">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('borroPartyNam') ? 'is-invalid' : ''); ?>" name="borroPartyNam" id="borroPartyNam" placeholder=" Name of party/account" value="" type="">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('borrSrNum') ? 'is-invalid' : ''); ?>" name="borrSrNum" id="borrSrNum" placeholder="Enter LAN number " value="" type="">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('natureOfAc') ? 'is-invalid' : ''); ?>" name="natureOfAc" id="natureOfAc" placeholder="Nature of Account " value="" type="">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('borroDateSanction') ? 'is-invalid' : ''); ?>" name="borroDateSanction" id="borroDateSanction" placeholder=" " value="" type="date">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('sanctionedLimit') ? 'is-invalid' : ''); ?>" name="sanctionedLimit" id="sanctionedLimit" placeholder="Sanctioned limit " value="" type="number">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('disbursedAmount') ? 'is-invalid' : ''); ?>" name="disbursedAmount" id="disbursedAmount" placeholder="Disbursed amount " value="" type="number">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input class="form-control  <?php echo e($errors->has('balanceOutstanding') ? 'is-invalid' : ''); ?>" name="balanceOutstanding" id="balanceOutstanding" placeholder="Balance Outstanding" value="" type="number">
            ...
            <div class="row">
                ...
                <!-- <div class="form-group col-sm-3">
                    <label class="required" for="srNumAssCon">Sr. No. Associate Director</label>
                    <input class="form-control  <?php echo e($errors->has('srNumAssCon') ? 'is-invalid' : ''); ?>" name="srNumAssCon" id="srNumAssCon" placeholder="Sr. No. Associate Director" value="" type="number">
                    <?php if($errors->has('srNumAssCon')): ?>
                    <div class="invalid-feedback">
                        <?php echo e($errors->first('srNumAssCon')); ?>
            ...
            <div class="form-group text-center" style="margin:auto;padding-top:20px">
                ...
                <a class="btn btn-dark" href="<?php echo e(route('admin.fmr.index')); ?>">
                    CANCEL
                </a>
            </div>
        </form>
...
<script>
    ...
    function validateForm() {
        ...
        var notRptPo = $('#notRptPo').val();
        var DofFilling = $('#DofFilling').val();
        var position = $('#position').val();
        var clainLodge = $('#clainLodge').val();

        var clainLodgeReason = $('#clainLodgeReason').val();
        var intInvestigation = $('#intInvestigation').val();

        var deptInquiry = $('#deptInquiry').val();
        var deptInqEmpName = $('#deptInqEmpName').val();
        var deptInqEmpDesignation = $('#deptInqEmpDesignation').val();
        ...
        // var borroPartyNam = $('#borroPartyNam').val();
        // var srNumAssCon = $('#srNumAssCon').val();
        ...
        if (notRptPo == '') {
            $("#notRptPo").focus();
            $('#notRptPo-error').after('<span class="error">Reason not report to police is required</span>').show();
            return false;
        }
        if (position == '') {
            $("#position").focus();
            $('#position-error').after('<span class="error">Position is required</span>').show();
            return false;
        }
        if (clainLodge == '') {
            $("#clainLodge").focus();
            $('#clainLodge-error').after('<span class="error">Insurance claim lodged is required</span>').show();
            return false;
        }
        if (clainLodgeReason == '') {
            $("#clainLodgeReason").focus();
            $('#clainLodgeReason-error').after('<span class="error">If not, reason is required</span>').show();
            return false;
        }

        if (intInvestigation == '') {
            $("#intInvestigation").focus();
            $('#intInvestigation-error').after('<span class="error">Any internal investigation is required</span>').show();
            return false;
        }
        if (deptInquiry == '') {
            $("#deptInquiry").focus();
            $('#deptInquiry-error').after('<span class="error">Departmental inquiry is required</span>').show();
            return false;
        }
        if (deptInqEmpName == '') {
            $("#deptInqEmpName").focus();
            $('#deptInqEmpName-error').after('<span class="error">Employee name is required</span>').show();
            return false;
        }
        if (deptInqEmpDesignation == '') {
            $("#deptInqEmpDesignation").focus();
            $('#deptInqEmpDesignation-error').after('<span class="error">Employee designation is required</span>').show();
            return false;
        }
        if (suspended == '') {
            $("#suspended").focus();
            $('#suspended-error').after('<span class="error">Wheather suspended is required</span>').show();
            return false;
        }
        if (notRptPo == '') {
            $("#notRptPo").focus();
            $('#notRptPo-error').after('<span class="error">Date of charge sheet is required</span>').show();
            return false;
        }
        if (punishAward == '') {
            $("#punishAward").focus();
        ...
        // if (
        //     (account_name_dir == '' && nameOfDirector == '' && dir_address == '') ||
        //     (account_name_asso == '' && nameOfAssoCornDir == '' && addressDir === '')
        //     ) {
        ...
        if (lan != '') {
            $.ajax({
                ...
                success: function(result) {
                    //console.log(result.data.disb_amount);
                    console.log(result);
                    if (result.success == 1) {
                        // $("#nameOfBranch").val(result.data.branch_name).attr('readonly',true);
                        // $("#district").val(result.data.district).attr('readonly',true);
                        // $("#state").val(result.data.state).attr('readonly',true);
                        ...
                        $("#provisionheld").val(result.data.principal_outstanding).attr('readonly', false);
                        ...
                        // $("#provisionheld").val('').attr('readonly', false);
    ...
    $(function () {
        $('#entity').change(function() {
           ...
           console.log("Sending AJAX request...");
            $.ajax({
                //url: 'generateNumber',
                url:"<?php echo e(route('admin.generateNumber')); ?>",
                type: 'GET',
                dataType: "json",
                data: { entity: selectedEntity},
                success: function(data) {
                    console.log(data);
                    // Populate the fraud number field with the generated fraud number
                    $('#FraudNumber').val(data.generatedCode);
                },
...
$(document).ready(function() {
    ...
    //     if ((nameOfDirector == '' && dir_address == '' && borroPartyNam == '') || (account_name_asso == '' && nameOfAssoCornDir == '' && addressDir == '')) {
    //         alert('fill one ');
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel_Project_Azure\pel_am\pel_am\resources\views/admin/fmr/create.blade.php ENDPATH**/ ?>